...
namespace EmployeeManagementSystem
{
    ...
    {
        /// <summary>// Создайте консольное приложение, которое позволит управлять данными сотрудников.
// Программа должна обеспечивать функционал добавления, обновления, получения информации о работниках и расчета их зарплаты.
...
namespace EmployeeManagementSystem
{
    ...
    public static class Program
    {
        ...
        /// <summary>
        /// Метод просмотра списка сотрудников 
        /// </summary>
        ...
        /// <summary>
        /// Метод на проверку отрицательных чисел
        /// </summary> 
        ...
        /// <summary>
        /// Метод на проверку целого числа
        /// </summary> 
    ...
    /// <summary>
    /// Главный класс программы - интерфейс пользователя
    /// </summary>
    public static class Program
    {
        private const decimal MinHourlyRate = 100;
